...
angular.module('simulador').service('calculos', [
    ...
    function (math, FPS) {
        ...
        var _calculoPresionGas = math.compile("densidadGas * gravedad * alturaGas"),
            _calculoPresionSalida = math.compile("presionGas + densidadLiquido * gravedad * alturaInicial - 0.5 * densidadLiquido * square( velocidadSalida ) - densidadLiquido * gravedad * alturaTubo"),
